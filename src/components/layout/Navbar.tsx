...
const Navbar: React.FC = () => {
  return (
    <header className="w-full py-4 px-6 sm:px-8 border-b border-gray-100 bg-white/90 backdrop-blur-md sticky top-0 z-20 shadow-sm">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2 group">
          <div className="bg-gradient-to-r from-blue-500 to-purple-500 p-2 rounded-lg transition-all duration-300 group-hover:scale-105 shadow-md">
            <MessageSquare className="h-5 w-5 text-white" />
          </div>
